...
Because the real upstream credential is stored inside AI Relay Box and injected during forwarding. Many OpenAI-compatible tools only require a non-empty local key value.
